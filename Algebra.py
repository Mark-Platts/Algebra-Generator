#All right reserved copyright:MarkPlattsTutoring
...
def alg_loop(pt,pc,pl,pequ):
    print(80*'\u2550')
    while True:
        print("Please type 'n' for a random equation, or 'l' to return to level select.")
        x = input()
        if x == 'n' or x == 'N':
            break
        elif x == 'l' or x == 'L':
    ...
    if equ_type == 1:
        ...
        sol = show_sol_2(equ)
    print(80*'\u2550')
    print(disp_equ(equ,equ_type))
    print(80*'-')
    print("Type your answer or type 's' to see the solution")
    while True:
        y = input()
        if y == ans:
            print("Correct, well done!\n")
            break
        elif y != ans and y != 's' and y != 'S' and y != 'd' and y != 'D':
            print("Sorry! Try again or type 's' to see the solution.")
        elif y == 's' or y == 'S':
            print(80*'\u2550')
            print(sol)
            break
...
def level_loop():
    print(80*'\u2550')
    while True:
        print("Please type a number from 1-5 to select a level.")
        x = input()
        if x in ('1','2','3','4','5'):
            break
        else:
